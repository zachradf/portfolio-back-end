...
repoActionsController.upsertFile =  async (req, res) => {
 try {
      const data = await githubService.upsertFile(req, res)
  ...
  repoActionsController.createRepo = async (req, res) => {
    ...
    try {
      const data = await githubService.createRepo(name, description, privateRepo, authToken);
      res.json(data);
    } catch (error) {
  ...
  repoActionsController.createPullRequest = async (req, res) => {
    ...
    try {
      const data = await githubService.createPullRequest(owner, repo, title, head, base, body, authToken);
      res.json(data);
    } catch (error) {
